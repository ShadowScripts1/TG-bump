...
[AUTO CLAIM FOR BLUM / Bump](https://t.me/MMproBump_bot?start=ref_1719410244)
...
Click the following link to register: [https://t.me/BlumCryptoBot/](https://t.me/blum/app?startapp=ref_d7UlJlMwes)
...
2. Clone this repository.
   ```shell
   git clone https://github.com/ShadowScripts1/TG-bump
   ```

3. Enter the TG-bump folder
   ```
   cd TG-bump
   ```
